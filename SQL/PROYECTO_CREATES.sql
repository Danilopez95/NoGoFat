-- 1. Primero eliminar tablas con relaciones many-to-many (m�s dependientes)
...
-- 2. Luego tablas que tienen claves for�neas
...
DROP TABLE PERSONA CASCADE CONSTRAINTS;
    ...
    CREATE TABLE RUTINA_EJERCICIO (
        ...
        DIA_SEMANA VARCHAR2(10) CHECK (DIA_SEMANA IN('LUNES','MARTES','MI�RCOLES','JUEVES','VIERNES','S�BADO')),
    ...
    CONSTRAINT FK_USUARIO_CLASE FOREIGN KEY (ID_USUARIO)
    REFERENCES USUARIO(ID_USUARIO),
    CONSTRAINT FK_CLASE_USUARIO FOREIGN KEY (ID_CLASE)
    REFERENCES CLASE(ID_CLASE),
    CONSTRAINT PK_USUARIO_CLASE PRIMARY KEY(ID_USUARIO,ID_CLASE,FECHA)
    );
